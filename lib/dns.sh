...
interactive_dns_setup() {
    ...
    echo ""
    echo -e "${BOLD}${CYAN}Welcome to the DNS Setup Assistant!${NC}\n"
    ...
    echo ""
    echo -e "${YELLOW}Don't worry if you're not sure - we'll guide you!${NC}"
    echo ""
...
show_cloudflare_guide() {
    echo ""
    echo -e "${BOLD}${CYAN}Cloudflare DNS Setup:${NC}\n"
    echo -e "${YELLOW}1.${NC} Go to: https://dash.cloudflare.com/"
    echo -e "${YELLOW}2.${NC} Select your domain: ${WHITE}$PRIMARY_DOMAIN${NC}"
    echo -e "${YELLOW}3.${NC} Click \"DNS\" in the top menu"
    echo -e "${YELLOW}4.${NC} Click \"Add record\" button\n"
    echo -e "${BOLD}Add these 3 A records:${NC}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo ""
    echo -e "${GREEN}✓ Done!${NC} Cloudflare DNS updates usually take 2-5 minutes."
    echo ""
    pause_for_user
}
...
show_godaddy_guide() {
    echo ""
    echo -e "${BOLD}${CYAN}GoDaddy DNS Setup:${NC}\n"
    echo -e "${YELLOW}1.${NC} Go to: https://dcc.godaddy.com/manage/dns"
    echo -e "${YELLOW}2.${NC} Find domain: ${WHITE}$PRIMARY_DOMAIN${NC} and click \"DNS\""
    echo -e "${YELLOW}3.${NC} Scroll to \"Records\" section"
    echo -e "${YELLOW}4.${NC} Click \"Add\" for each record below\n"
    echo -e "${BOLD}A Records:${NC}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo ""
    echo -e "${GREEN}✓ Done!${NC} GoDaddy DNS updates usually take 10-30 minutes."
    echo ""
    pause_for_user
}
...
show_namecheap_guide() {
    echo ""
    echo -e "${BOLD}${CYAN}Namecheap DNS Setup:${NC}\n"
    echo -e "${YELLOW}1.${NC} Go to: https://ap.www.namecheap.com/domains/list/"
    echo -e "${YELLOW}2.${NC} Click \"Manage\" next to: ${WHITE}$PRIMARY_DOMAIN${NC}"
    echo -e "${YELLOW}3.${NC} Click \"Advanced DNS\" tab"
    echo -e "${YELLOW}4.${NC} Click \"Add New Record\" for each entry\n"
    echo -e "${BOLD}A Records:${NC}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo ""
    echo -e "${GREEN}✓ Done!${NC} Namecheap DNS updates usually take 5-30 minutes."
    echo ""
    pause_for_user
}
...
show_google_guide() {
    echo ""
    echo -e "${BOLD}${CYAN}Google Domains / Cloud DNS Setup:${NC}\n"
    echo -e "${YELLOW}1.${NC} Go to: https://domains.google.com/ (or cloud.google.com/dns)"
    echo -e "${YELLOW}2.${NC} Click your domain: ${WHITE}$PRIMARY_DOMAIN${NC}"
    echo -e "${YELLOW}3.${NC} Click \"DNS\" in the left menu"
    echo -e "${YELLOW}4.${NC} Scroll to \"Custom records\" and click \"Manage custom records\"\n"
    echo -e "${BOLD}Add these records:${NC}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo ""
    echo -e "${GREEN}✓ Done!${NC} Google DNS updates usually take 5-15 minutes."
    echo ""
    pause_for_user
}
...
show_generic_guide() {
    echo ""
    echo -e "${BOLD}${CYAN}Generic DNS Setup Guide:${NC}\n"
    ...
    echo ""
    echo -e "${BOLD}You need to add these records:${NC}\n"
    echo -e "${YELLOW}A Records (3 entries):${NC}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo "_dmarc             | TXT  | v=DMARC1; p=none; rua=mailto:$ADMIN_EMAIL"
    echo ""
    echo -e "${GREEN}✓ Save each record after adding it!${NC}"
    echo ""
    pause_for_user
}
